...
<div class="container" style="width:70%;">	
	 <form  action="../Acc/getInfodeposit" method="post"class="depositInfo">			
...
<%@page import="com.bank.Dao.*;"%> 
		<div id="deposit">		
			<form  action="../transction/cashDeposit" method="post" class="depositAmount">			
				 <div class="row " style="margin-bottom:33px;">				
							<div class="col-md-6 ">			
									...
									%>
									<label>Account No:</label>										
									<input type="text" class="form-control" name="num" value="<%=obj.getACno() %>">
				 ...
				 <div class="row " style="margin-bottom:33px;">				
							...
							<div class="col-md-6">	
									...
									<input type="text" class="form-control" name="bal" value="<%=obj.getAmount()%>">
							</div>							
				</div>
				 <div class="row " style="margin-bottom:33px;">				
							<div class="col-12">	
									<label>Deposit Amount:</label>													
									<input type="text" class="form-control" placeholder="Enter deposit Amount" name="depBal" value="">
							</div>
				</div>				
				<div class="row  AccBtn" style="margin-bottom:33px;">
					<div class=" col-12">
					<button type="submit"  class=" btn btn-primary btn-style" >Deposit Amount</button>
					</div>
				</div>
		</form>		
